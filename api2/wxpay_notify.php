...
//获取微信支付APPID等信息
$sql = "SELECT pay_fee, pay_config FROM ". $ecs->table('payment'). " WHERE pay_id=8";		//这里的pay_id不一定为4, 根据实际情况更改
...
$params = array(
	...
	'body'				=> 	'百度科技网络',									//这里填你的商户信息， 比如说百度
	'out_trade_no'		=> 	$orderInfo['order_sn'],
	'fee_type'			=>	'CNY',
	'total_fee'			=>	intval($orderInfo['order_amount'] * 100),
	'spbill_create_ip'	=>	$cip,
	'notify_url'		=>	'http://win.qbt8.com/guoa/respond.php',				//记得改这里
	'trade_type'		=>	'NATIVE',
