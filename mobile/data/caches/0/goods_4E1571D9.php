<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:47:"D:/wwwroot/guoa/mobile/themes/miqinew/goods.dwt";i:1;s:58:"D:/wwwroot/guoa/mobile/themes/miqinew/library/comments.lbi";i:2;s:61:"D:/wwwroot/guoa/mobile/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1452762442;s:8:"maketime";i:1452758842;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>测试1_品牌专区_甜心100 触屏版</title>
...
<link href="themes/miqinew/ectouch.css?id=11" rel="stylesheet" type="text/css" />
...
<section class="goods_slider">
  ...
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201512/thumb_img/255_thumb_G_1450216095975.jpg"  alt="测试1" /></a></div>-->
      <ul>
	  <li><a href="javascript:showPic()"><img alt="" src="http://win.qbt8.com/images/201512/source_img/255_G_1450216095013.jpg"/></a></li>
         
         
		 
         
		        <li><a href="javascript:showPic()"><img alt="" src="http://win.qbt8.com/images/201512/thumb_img/255_thumb_P_1450289749892.jpg"/></a></li>
		 
         
		        <li><a href="javascript:showPic()"><img alt="" src="http://win.qbt8.com/images/201512/thumb_img/255_thumb_P_1450289750942.jpg"/></a></li>
		 
         
		        <li><a href="javascript:showPic()"><img alt="" src="http://win.qbt8.com/images/201512/thumb_img/255_thumb_P_1450289751771.jpg"/></a></li>
		 
         
		        <li><a href="javascript:showPic()"><img alt="" src="http://win.qbt8.com/images/201512/thumb_img/255_thumb_P_1450289752384.jpg"/></a></li>
...
<div style="float:right;overflow: hidden;background: #950000;aligin:center; height: 2.5rem; line-height:2.5rem; text-align:center;">
 ...
 <div style="clear:both"></div>
  ...
  <a class="collect" id="collect_box" href="javascript:collect(255)" style="display: inline;"></a>
  <div class="title">
    <h1> 测试1 </h1>
  </div>
    <div class="title">
  ...
  <ul>
        <li>本店售价：<b class="price">￥<span>80</span></b>　    <del>￥<span>96</span></del> 
    </li>
...
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <div>请选择<span>同类序列</span><i></i></div>
    <div class="selected"> </div>
    </label>
    <form action="javascript:addToCart(255)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
     <div class="fields"   style="display: block;">	 
        ...
        <ul class="ul2">
          ...
          <h2>同类序列：</h2>
            <div class="items">
                            				  										...
                            				  										<input type="radio" name="spec_236" value="575" id="spec_value_575" checked onclick="changePrice()" />
                    <label for="spec_value_575">2009</label> 
										<input type="radio" name="spec_236" value="576" id="spec_value_576"  onclick="changePrice()" />
                    <label for="spec_value_576">2010</label> 
        ...
        <ul class="quantity">
          ...
          <div class="items"> <span class="ui-number radius5"> 
            ...
            <input class="num" name="number" id="goods_number" autocomplete="off" value="1" min="1" max="991" type="number" />
      ...
      <div class="option" > 
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(255)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(255);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://win.qbt8.com/images/201512/source_img/255_G_1450216095013.jpg"> </div>
            <div id="right">
              <p>测试1</p>
...
<section class="s-detail">
  <header>
    <ul style="position: static;" id="detail_nav">
      ...
      <li id="tabs2" onClick="tab(2)" class=""> 评价 <span class="review-count">(2)</span> </li>
  ...
  <div id="tab1" class="">
    <div class="desc wrap">
      <div class="blank2"></div>
	  		...
	  		<table width="90%" id="detail-table" style="color:#192E32;font-family:sans-serif, Arial, Verdana;font-size:12px;background-color:#FFFFFF;">
	<tbody>
		<tr>
			<td style="font-family:sans-serif, Arial, Verdana;">
				商品详情
			</td>
		</tr>
	</tbody>
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transport.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:255;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
  <div id="tab3" class="hidden">
    <div class="wrap">
      <ul class="m-recommend ">
        ...
        <li class="flex_in  "    > <a href="goods.php?id=238">
        <div class="summary radius5"> <img src="http://win.qbt8.com/images/201512/thumb_img/238_thumb_G_1450201715274.jpg" alt=""/>
          <div class="price"> 
        ...
        <li class="flex_in  "    style="float:right"  > <a href="goods.php?id=249">
        <div class="summary radius5"> <img src="http://win.qbt8.com/data/static/images/no_picture.gif" alt=""/>
          <div class="price"> 
        ...
        <li class="flex_in  "    > <a href="goods.php?id=252">
        <div class="summary radius5"> <img src="http://win.qbt8.com/data/static/images/no_picture.gif" alt=""/>
          <div class="price"> 
...
<div id="content" class="footer mr-t20">
  ...
  <p class="link region"> <a href="http://win.qbt8.com/?computer=1"> 电脑版 </a> <a href="./"> 触屏版 </a> <a href="#"> 苹果客户端 </a> <a class="#"> Android客户端 </a> </p>
  <p class="region"> 
     
    &copy; 2005-2016 甜心100 版权所有，并保留所有权利。 </p>
...
<script>
  wx.config({
    ...
    timestamp: 1452758843,
    nonceStr: 'mf3FfjUjH6Mq1dug',
    signature: 'a4f7c11ce0441e044389533049effaf4aff1a676',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      ...
      desc: '测试1',
      link: '',
      imgUrl: 'http://win.qbt8.com/images/201512/source_img/255_G_1450216095013.jpg',
