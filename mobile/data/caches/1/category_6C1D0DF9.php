<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:61:"E:/wwwroot/shop_wd6789_com/mobile/themes/miqinew/category.dwt";i:1;s:78:"E:/wwwroot/shop_wd6789_com/mobile/themes/miqinew/library/goods_list_search.lbi";i:2;s:66:"E:/wwwroot/shop_wd6789_com/mobile/themes/miqinew/library/pages.lbi";i:3;s:72:"E:/wwwroot/shop_wd6789_com/mobile/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1426739660;s:8:"maketime";i:1426736060;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>彩妆_江西电信 触屏版</title>
...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class=""> <a href="category.php?category=1&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC&keywords=#goods_list&">综合</a> </li>
      <li class=""> <a href="category.php?category=1&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=DESC&keywords=#goods_list">人气<i class="f-ico-arrow-d"></i></a> </li>
      <li class=""> <a href="category.php?category=1&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_count&order=DESC&keywords=#goods_list">销量</a></li>
      <li class=""> <a href="category.php?category=1&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC&keywords=#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
    ...
    <input type="hidden" name="order" value="" />
        ...
        <div class="pro-inner">
          <div class="proImg-wrap"> <a href="goods.php?id=149" > <img src="http://shop.wd6789.com/images/201503/thumb_img/149_thumb_G_1426706647519.jpg" alt="苹果6S 测试商品"> </a> </div>
          <div class="proInfo-wrap">
            <div class="proTitle"> <a href="goods.php?id=149" >苹果6S 测试商品</a> </div>
            ...
            <div class="proService"> <del>￥<span>12</span></del></div>
            <div class="proSales">月销量:<em>0</em></div>
            <div class="proIcons"> 
			  
			<img width="55" height="16" src="themes/miqinew/images/watermark_promote_small.png" alt="苹果6S 测试商品" />
        ...
        <div class="pagenav" id="J_PageNav" style="display:flex; text-align:center;">
          ...
          <div class="pagenav-cur">
            ...
            <select name="page" class="pagenav-select" onchange="window.location.href=this.options[this.selectedIndex].value" >
              ...
              <option value="category.php?id=1&page=1">1</option>
                                    </select>
          </div>
    ...
    <div class="attrs attr-fix" style="overflow: auto;height: 100%"> 
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
              ...
              <a href="javascript:void(0);" data="10|11">10&nbsp;-&nbsp;11</a></li>
                        <input type="hidden" name="price_min" value="0" />
            <input type="hidden" name="price_max" value="0" />
          </ul>
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
              ...
              <a href="javascript:void(0);" data="328">白色</a></li>
             
                        <li class="filter_attr"> 
               
              <a href="javascript:void(0);" data="327">黑色</a></li>
                      </ul>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=1&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=&order=', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/miqinew/images/loader.gif" /></div>'})
