...
class wx_new_qrcode
{
	...
	function get_code($order, $payment)
	{
        ...
        $html = '';
        //<button type="button" onclick="javascript:alert(\'出错了\')">微信支付</button>
        if($unifiedOrderResult["code_url"] != NULL)
        {
            ...
            $html .= "<div style=\"text-align:center\">支付后点击<span style=\"color:red;    cursor: pointer;\" onclick=\"location.href='user.php?act=order_list'\">此处</span>查看我的订单</div>";
        }
