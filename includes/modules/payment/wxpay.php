...
class wxpay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $stringSignTemp  = $param. 'key='. $payment['app_secret'];
        ...
        $button = '<div style="text-align:center"><input type="button" class="pay_a" onclick="window.open(\'user.php?act=build_qrcode&data='.$url.'\')" value="' .$GLOBALS['_LANG']['pay_button']. '" /></div>';
