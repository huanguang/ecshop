...
class tenpay
{
    ...
    function get_code($order, $payment)
    {
        ...
        /* 返回的路径 */
        $return_url = $GLOBALS['ecs']->url() . 'respond.php?code=tenpay';
        ...
        $button  .= '<input type="image" src="'. $GLOBALS['ecs']->url() .'themes/miqinew/images/icon_order1_03.png" value="' .$GLOBALS['_LANG']['pay_button']. '" /></form>';
