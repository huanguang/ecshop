...
if ($_REQUEST['act'] =='update')
{
    ...
    $sql = "UPDATE  ".$ecs->table('booking_goods').
            " SET is_dispose='1', dispose_note='$dispose_note', ".
                    " order_sn = '" .$order_sn. "' ,dispose_time='" .gmtime(). "', dispose_user='".$_SESSION['admin_name']."'".
...
function get_booking_info($id)
{
    ...
    $sql ="SELECT bg.rec_id, bg.user_id,bg.order_sn, IFNULL(u.user_name, '$_LANG[guest_user]') AS user_name, ".
