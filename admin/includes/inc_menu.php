...
$modules['02_cat_and_goods']['54_online_consultation']     = 'news.php?act=list'; //在线咨询列表
$modules['02_cat_and_goods']['17_tag_manage']       = 'tag_manage.php?act=list';
$modules['02_cat_and_goods']['zhengji']       = 'zhengji.php?act=list';
$modules['02_cat_and_goods']['jiameng']       = 'jiameng.php?act=list';
...
$modules['14_sms']['07_sms_zixun']                   = 'zixun.php?act=list';
