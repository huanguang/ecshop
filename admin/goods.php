...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $zhuanti = isset($_POST['zhuanti']) ? 1 : 0; //20151128添加
    ...
    $goods_name_e = isset($_POST['goods_name_e']) ? $_POST['goods_name_e'] : '';
    $goods_qitajie = isset($_POST['goods_qitajie']) ? $_POST['goods_qitajie'] : '';
    $goods_jiany = isset($_POST['goods_jiany']) ? $_POST['goods_jiany'] : '';
    $goods_liangdian = isset($_POST['goods_liangdian']) ? $_POST['goods_liangdian'] : '';
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, rank_integral, suppliers_id , goods_shipai,mobile_desc,zhuanti,goods_name_e,goods_qitajie,goods_liangdian,goods_jiany )" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$rank_integral', '$suppliers_id' , '$_POST[goods_shipai]','$_POST[mobile_desc]',$zhuanti,'$goods_name_e','$goods_qitajie','$goods_liangdian','$goods_jiany')";
        }
        else
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, extension_code, rank_integral ,  goods_shipai,mobile_desc,zhuanti,goods_name_e,goods_qitajie,goods_liangdian,goods_jiany)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', 0, '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$code', '$rank_integral' , '$_POST[goods_shipai]','$_POST[mobile_desc]',$zhuanti,'$goods_name_e','$goods_qitajie','$goods_liangdian','$goods_jiany')";
        }
    }
    else
    {
        ...
        $sql .= "keywords = '$_POST[keywords]', " .
                ...
                "goods_name_e = '$goods_name_e', " .
                "goods_liangdian = '$goods_liangdian', " .
                "goods_jiany = '$goods_jiany', " .
                "is_alone_sale = '$is_alone_sale', " .
                "goods_qitajie = '$goods_qitajie', " .
