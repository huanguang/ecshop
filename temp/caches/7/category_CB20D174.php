<?php exit;?>a:3:{s:8:"template";a:6:{i:0;s:43:"D:/wwwroot/guoa/themes/miqinew/category.dwt";i:1;s:54:"D:/wwwroot/guoa/themes/miqinew/library/page_header.lbi";i:2;s:50:"D:/wwwroot/guoa/themes/miqinew/library/ur_here.lbi";i:3;s:53:"D:/wwwroot/guoa/themes/miqinew/library/zuhesousuo.lbi";i:4;s:48:"D:/wwwroot/guoa/themes/miqinew/library/pages.lbi";i:5;s:54:"D:/wwwroot/guoa/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1466876875;s:8:"maketime";i:1466873275;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>拉菲_秀当红酒商城</title>
...
<!--</div>-->
<div class="cur_wz">
	<span><a href="index.php"></a></span> <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=145">拉菲</a></div>
<script>
  ...
  function change()
{
  ...
  <tr>
    <td width="80" align="left" nowrap><strong><span class="ar">拉菲      
    </span></strong></td>
    <td align="left" >    </td>
  ...
  <div class="div_f3">
    <table width="100%" border="0" cellspacing="0" cellpadding="6">
        <tr>
         ...
         <a href="category.php?id=145&amp;price_min=0&amp;price_max=0" class="box1 ab" style="color:red;">全部</a>
         
                                     
                                                   
        <a href="category.php?id=145&amp;brand=74&amp;price_min=0&amp;price_max=0" class="box1 ab" >莱温迪</a> <label class="box2"><input class="aass" name="hy" type="checkbox"  value="莱温迪" >莱温迪 </label>
...
<td class="line1">
  ...
  window.location.href="category.php?category=145&display=grid&brand=0&price_min=0&pin="+cc+"&shux="+ss+"&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list";
}
  </script>
        </tr>
      </table>
...
<div class="screen">
    	<ul>
        	<li class="cur"><a href="category.php?category=145&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list">全部</a></li>
        	<li class="li1"><a href="category.php?category=145&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list">人气</a></li>
        	<li class="li2"><a href="category.php?category=145&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">销量</a></li>
        </ul>
        <div class="money">
        	价格
            ...
            <script type="text/javascript">
                function cha(){
                   ...
                   window.location.href="category.php?category=145&display=grid&brand=0&price_min="+max+"&price_max="+min+"&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list";
                    }
                }
                function chaxun(obj,aa){
                    ...
                    window.location.href="category.php?category=145&display=grid&"+add+ass+asss+"&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"
                }
            </script>
        </div>
<div class="xlsx fl">
...
<div class="wedding" id="trc1">
            	<ul>
                                        					<li>
						<div class="pic"><a href="goods.php?id=221"><img src="images/201603/thumb_img/221_thumb_G_1457028237600.jpg" width="185" height="160"></a></div>
						<div class="wz">
                          <div class="jg">
                                            <span>0</span>
                                   <s>0</s>
                                        </div>
                        	<div class="tit"><a href="goods.php?id=221">澳洲原瓶进口红酒 黄尾袋鼠加本力苏维翁/赤霞珠半干红葡萄酒6支</a></div>
                            <div class="an">
                            	<a class="gwc" href="javascript:addToCartShowDiv(221,1,'best');"><img src="themes/miqinew/images/car.png" />加入购物车</a>
                            	<a class="ljgm" href="goods.php?id=221">立即购买</a>
                                <div class="clear"></div>
                            </div>
                            <div class="yshp">
                            ...
                            <div class="sucess_joinCart" id="addtocartdialog_retui_221_best"></div>
                      	</div>
					</li>
                                         </ul>
                <div class="clear"></div>
...
<div class="wedding" id="trc2" style="display:none">
  ...
  <tr>
    <td width="200" rowspan="2" align="center"><a href="goods.php?id=221"><img src="images/201603/thumb_img/221_thumb_G_1457028237600.jpg" width="185" height="160" /></a></td>
    <td height="80" colspan="2" valign="top" class="wedding_td_2">
      <h2><a href="">澳洲原瓶进口红酒 黄尾袋鼠加本力苏维翁/赤霞珠半干红葡萄酒6支</a></h2>
                  <p>0</p>
                </td>
    <td align="center" valign="bottom" class="wedding_td_4"><a href="javascript:addToCartShowDiv2(221,1,'best');">加入购物车</a></td>
    <td width="190" rowspan="2" align="center"><img src="themes/miqinew/images/yz_13.jpg" width="165" height="102" /><div class="sucess_joinCart" id="addtocartdialog_retui2_221_best"></div></td>
  </tr>
  <tr>
    ...
    <td align="center" valign="middle" class="wedding_td_5"><a href="goods.php?id=221">立即购买</a></td>
    </tr>
</table>
                     <div class="clear"></div>
            </div>
...
<div class="searchRight_paging">
 <div id="pager" class="pagebar">
  ...
  <div class="activity_all">
                      ...
                      <a href="category.php?id=145&amp;price_min=0&amp;price_max=0&amp;page=2&amp;sort=goods_id&amp;order=DESC">2</a>
                      <a href="category.php?id=145&amp;price_min=0&amp;price_max=0&amp;page=3&amp;sort=goods_id&amp;order=DESC">3</a>
                      <a href="category.php?id=145&amp;price_min=0&amp;price_max=0&amp;page=4&amp;sort=goods_id&amp;order=DESC">4</a>
            
  <a class="activity_next" href="category.php?id=145&amp;price_min=0&amp;price_max=0&amp;page=2&amp;sort=goods_id&amp;order=DESC">下一页</a>     
