...
?> 
    ...
    <div id="cn_h" class="recommend_collocation_con  clearfix"> 
      ...
      <?php $_from = $this->_var['fittings_tab_index']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'tab_item');$this->_foreach['names'] = array('total' => count($_from), 'iteration' => 0);
...
<li>
  ...
  <div class="zjzh_li_1">
          <img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" width="185" height="160">
            <p><?php echo sub_str($this->_var['goods']['goods_name'],28); ?></p>
...
<?php $_from = $this->_var['fittings']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_list');$this->_foreach['name'] = array('total' => count($_from), 'iteration' => 0);
...
<?php if ($this->_foreach['name']['iteration'] < 5): ?>
      ...
      <a href="<?php echo $this->_var['goods']['url']; ?>">
  <div class="zjzh_li_1">
          <img src="<?php echo $this->_var['goods_list']['goods_thumb']; ?>" width="185" height="160">
            <p><?php echo sub_str($this->_var['goods_list']['goods_name'],28); ?></p>
...
<?php if ($this->_foreach['name']['iteration'] == '4'): ?><li class="zjzh_li2"></li><?php else: ?>
 <li class="zjzh_li1"></li> <?php endif; ?>            
 <?php endif; ?>
 <?php endif; ?>
              <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
<table width="200" border="0" cellspacing="0" cellpadding="0" class="zjzh_ta">
  ...
  <tr>
    <td height="30" colspan="2" align="center"><a href="javascript:addMultiToCart('m_goods_<?php echo $this->_var['key']; ?>', '<?php echo $this->_var['goods']['goods_id']; ?>')">购买套装</a></td>
    </tr>
</tbody></table>
</li>
</ul>
