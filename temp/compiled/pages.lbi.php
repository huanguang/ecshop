...
<div class="searchRight_paging">
 <div id="pager" class="pagebar">
  ...
  <?php if ($this->_var['pager']['page_first']): ?><a style="width:50px;" href="<?php echo $this->_var['pager']['page_first']; ?>"><?php echo $this->_var['lang']['page_first']; ?></a><?php endif; ?>
  <?php if ($this->_var['pager']['page_prev']): ?><a class="activity_prev " href="<?php echo $this->_var['pager']['page_prev']; ?>">上一页</a><?php endif; ?>
...
?>
  ...
  <?php if ($this->_var['pager']['page_last']): ?><a class="last"  style="width:50px;" href="<?php echo $this->_var['pager']['page_last']; ?>"><?php echo $this->_var['lang']['page_last']; ?></a><?php endif; ?>
