...
if (!$smarty->is_cached('article.dwt', $cache_id))
{
    ...
    $smarty->assign('class_articles', index_get_class_articles($article_id,100)); // 分类调用文章 
...
//调用一篇文章的详细内容
    ...
    $article_index = $db->getRow($sql);
        $smarty->assign('article_info',$article_index);
    
    $smarty->display('culture_info.dwt');
